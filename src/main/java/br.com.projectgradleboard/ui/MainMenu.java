...
import main.java.br.com.projectgradleboard.service.BoardService;
...
public class MainMenu {
    ...
    public void execute() throws SQLException {
        ...
        while (true) {
            System.out.println("1 - Crair um novo board");
    ...
    private void createBoard() throws SQLException {
        ...
        entity.getColumns(columns);

        try (var connection = getConnection()) {
            var service = new BoardService(connection);
            service.inser(entity);
        }
    }
    ...
    private void selectBoard() throws SQLException {
        ...
        try (var connection = getConnection()) {
            ...
            optional.ifPresentOrElse(b -> new BoardMenu(b).execute(),
                    () -> System.out.println("Não foi encontrado u mboard com id %s\n", id));
        }
    }
    ...
    private BoardColumnEntity createColumn(final String name, final EBoardColumnKindEnum kind, final int order) {
